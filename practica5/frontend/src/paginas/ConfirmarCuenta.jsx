    ...
    return (
        ...
        <div className="w-60 h-60 overflow-hidden"></div>
          ...
          <div className="bg-purple-700 rounded p-8 w-full md:w-1/2">
            <h1 className="text-2xl mb-4 font-bold text-gray-800">La operación se ha realizado exitosamente</h1>
            <br />
            <h2 className="block mb-2 text-white"><a href="http://localhost:5173/">Volver al inicio</a></h2>
          </div>
          <div className="w-60 h-60 overflow-hidden"></div>
        </div>
      </div>
